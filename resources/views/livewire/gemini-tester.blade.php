        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            @empty
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Benvenuto in Gemini AI Tester</h3>
                    <p class="text-gray-500 max-w-md mx-auto">
                        Inizia una conversazione o carica un file Excel/PDF per analizzarlo con Gemini.
                    </p>
                </div>
            @endforelse
                    ...
                    <div class="flex items-start space-x-3 max-w-3xl">
                        ...
                        <div class="bg-white px-4 py-3 rounded-2xl shadow-sm border border-gray-200">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500">Gemini sta pensando...</span>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
<script>
    // Logging Gemini API Request in console browser
    ...
    // Logging Gemini API Response in console browser
